...
R Markdown is a  tool for iterating programs, integrating code, output, etc. in one document. 

### R Markdown and Code Chunck

To include R code in  Rmarkdwon document, insert a code chunk.
...
```
You can also use R Markdown Formatting to organize documents:
